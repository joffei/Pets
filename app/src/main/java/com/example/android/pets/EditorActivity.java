...
public class EditorActivity extends AppCompatActivity {
    ...
    private void insertPet(){
        ...
        Toast confirmation;
        //confirmation.setDuration(Toast.LENGTH_LONG);

        if(result == -1){

            confirmation = Toast.makeText(getApplicationContext(), "Error with saving pet", Toast.LENGTH_LONG);
        }else{
            confirmation = Toast.makeText(getApplicationContext(), "Pet saved with id: " + result, Toast.LENGTH_LONG);
        }
